...
let TerminusOptionsService = class TerminusOptionsService {
    constructor(dNSHealthIndicator, diskHealthIndicator) {
        ...
        const healthEndpoint = {
            ...
            healthIndicators: [
                () => __awaiter(this, void 0, void 0, function* () {
                    return this.dNSHealthIndicator.pingCheck('Orteo API', 'https://api.orteo.co');
                }),
                () => __awaiter(this, void 0, void 0, function* () {
                    return this.diskHealthIndicator.checkStorage('storage', {
