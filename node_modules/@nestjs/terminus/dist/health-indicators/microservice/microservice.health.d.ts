...
export declare type MicroserviceHealthIndicatorOptions = ClientOptions & {
    timeout?: number;
};
/**
...
export declare class MicroserviceHealthIndicator extends HealthIndicator {
     ...
     * })
     */
    pingCheck(key: string, options: MicroserviceHealthIndicatorOptions): Promise<HealthIndicatorResult>;
}
