 ...
 */
export declare type TerminusLogger = (message: any, error?: HealthCheckError | Error) => any;
/**
...
export interface TerminusModuleAsyncOptions extends Pick<ModuleMetadata, 'imports'> {
     ...
     */
    useFactory?: (...args: unknown[]) => Promise<TerminusModuleOptions> | TerminusModuleOptions;
    /**
